...
cwndDict04 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
cwndDict15 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
goodputDict04 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
goodputDict15 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
rttDict04 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
rttDict15 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
lostDict04 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
lostDict15 = {"reno": [0] * 1001, "yeah": [0] * 1001, "cubic": [0] * 1001}
...
def addCwndDatas(renoData, yeahData, cubicData):
...
def addGoodputDatas(renoData, yeahData, cubicData):
...
def addRttDatas(renoData, yeahData, cubicData):
...
def addLostDatas(renoData, yeahData, cubicData):
...
def runOneEpoch():
	...
	addCwndDatas(renoData, yeahData, cubicData)
	addGoodputDatas(renoData, yeahData, cubicData)
	addRttDatas(renoData, yeahData, cubicData)
	addLostDatas(renoData, yeahData, cubicData)
